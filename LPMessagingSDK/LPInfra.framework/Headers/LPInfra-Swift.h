...
+ (NSInteger)convertFromUIBackgroundTaskIdentifier:(UIBackgroundTaskIdentifier)input SWIFT_WARN_UNUSED_RESULT;
+ (UIBackgroundTaskIdentifier)convertToUIBackgroundTaskIdentifier:(NSInteger)input SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
