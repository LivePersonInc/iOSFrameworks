...
/// Double number for the outline width. Default is UIColor.black
...
/// Enable or disable link preview feature. If disabled, user will not see site’s link preview or link preview. Default value is 0.3.
...
/// Double number for the outline width of link preview area inside cell. Default is UIColor(rgba: “#E2E3E3”).
...
@property (nonatomic, copy) NSString * _Nonnull customButtonIconName SWIFT_AVAILABILITY(ios,deprecated=1.4.1,message="use customButtonImage instead");
...
@property (nonatomic, copy) NSString * _Nonnull customButtonDescription SWIFT_AVAILABILITY(ios,deprecated=1.5.1,message="use customButtonAccessibilityDescription key in Localization languages files instead");
...
@property (nonatomic, strong) UIColor * _Nonnull checkmarkColor SWIFT_AVAILABILITY(ios,deprecated=1.2.16,message="use checkmarkReadColor instead");
@property (nonatomic, copy) NSString * _Nonnull readReceiptTextSent SWIFT_AVAILABILITY(ios,deprecated=1.5.1,message="use readReceiptTextSent key in Localization languages files instead");
@property (nonatomic, copy) NSString * _Nonnull readReceiptTextDistributed SWIFT_AVAILABILITY(ios,deprecated=1.5.1,message="use readReceiptTextDistributed key in Localization languages files instead");
@property (nonatomic, copy) NSString * _Nonnull readReceiptTextRead SWIFT_AVAILABILITY(ios,deprecated=1.5.1,message="use readReceiptTextRead key in Localization languages files instead");
...
@property (nonatomic, strong) UIColor * _Nonnull sendButtonDisabledTextColor SWIFT_AVAILABILITY(ios,deprecated=2.0.0,message="use sendButtonDisabledColor instead");
/// Send button color in enabled mode in the conversation screen
@property (nonatomic, strong) UIColor * _Nonnull sendButtonEnabledTextColor SWIFT_AVAILABILITY(ios,deprecated=2.0.0,message="use sendButtonEnabledColor instead");
/// Send button color in disabled mode in the conversation screen
...
@property (nonatomic, strong) UIColor * _Nonnull editTextUnderlineColor SWIFT_AVAILABILITY(ios,deprecated=2.0.0,message="underline is not used any more. To change background color of TextView container use inputTextViewContainerBackgroundColor");
...
@property (nonatomic) BOOL showUrgentButtonInTTRNotification SWIFT_AVAILABILITY(ios,deprecated=2.0.0,message="Urgent button was excluded from TTR view. Marking conversation as urgent is available now only from conversation menu");
...
///   </li>
/// </ul>
+ (void)unregisterPusher:(LPBrandEntity * _Nonnull)brand completion:(void (^ _Nonnull)(void))completion failure:(void (^ _Nonnull)(NSError * _Nonnull))failure SWIFT_AVAILABILITY(ios,deprecated=3.5.1,message="Use unregisterPusherFor(_ brandId: String) instead");
/// Unregister pusher.
/// <ul>
///   <li>
///     Account (brand account)
