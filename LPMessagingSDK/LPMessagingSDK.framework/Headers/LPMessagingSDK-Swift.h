...
+ (LPMessageEntity * _Nullable)createWelcomeLocalMessage:(LPDialogEntity * _Nonnull)dialog overrideTime:(NSDate * _Nonnull)overrideTime SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,deprecated=3.8.0,message="Use createWelcomeLocalMessage(_ dialog: Dialog, welcomeMessage: LPWelcomeMessage,  overrideTime: Date = Date()) -> Message? instead");
...
- (void)reconnect:(id <ConversationParamProtocol> _Nonnull)conversationQuery authenticationCode:(NSString * _Nonnull)authenticationCode SWIFT_AVAILABILITY(ios,deprecated=2.7.0,message="Use reconnect(_ conversationQuery: ConversationParamProtocol, authenticationParams: LPAuthenticationParams) instead");
...
- (void)setCustomButton:(UIImage * _Nullable)image SWIFT_AVAILABILITY(ios,deprecated=1.4.1,message="configure the image using customButtonImage in LPConfig instead");
/// This method checks if the active conversation of a conversation query marked as Urgent.
/// Return value:
/// True - conversation is marked as Urgent.
/// False - conversation is not marked as Urgent.
...
- (void)destruct;
- (void)logout SWIFT_AVAILABILITY(ios,deprecated=2.8.0,message="Use logout(completion: @escaping ()->(), failure: @escaping (_ error: Error)->()) instead");
...
- (void)LPMessagingSDKConversationEnded:(NSString * _Nullable)conversationID SWIFT_AVAILABILITY(ios,deprecated=2.1.0,message="use LPMessagingSDKConversationEnded(_:closeReason) instead");
