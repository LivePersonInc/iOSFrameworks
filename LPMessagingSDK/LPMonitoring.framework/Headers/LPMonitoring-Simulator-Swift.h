...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LPMonitoring",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12LPMonitoring23LPGetEngagementResponse")
...
SWIFT_CLASS("_TtC12LPMonitoring15LPMonitoringAPI")
@interface LPMonitoringAPI : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) LPMonitoringAPI * _Nonnull instance;)
+ (LPMonitoringAPI * _Nonnull)instance SWIFT_WARN_UNUSED_RESULT;
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
/// Initialize DataManager and its properties using mandatory params
/// \param accountID host app accountID
///
...
SWIFT_CLASS("_TtC12LPMonitoring17LPSendSDEResponse")
